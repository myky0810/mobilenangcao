...
class _BMWScreenState extends State<BMWScreen> with RouteAware {
  ...
  late List<Map<String, dynamic>> _bmwCars;
  ...
  void _loadCars() {
    setState(() {
      _bmwCars = CarDataService().getCarsByBrand('BMW');
    });
  }
